...
{
    /**
     * @param  array<string, mixed>  $data Data-set merged into the template to generate a document
     ...
     * @param  array<string, mixed>|null  $complement Extra data accessible in the template with {c.} instead of {d.}
     ...
     * @param  array<string, mixed>|null  $enum List of enumerations, use it in reports with `convEnum` formatters, documentation: https://carbone.io/documentation.html#convenum-type-
     * @param  array<string, array<string, string>>|null  $translations When the report is generated, all text between `{t( )}` is replaced with the corresponding translation. The `lang` option is required to select the correct translation. Learn more: https://carbone.io/documentation.html#translations
     ...
     * @param  array<string, float>|null  $currencyRates Currency exchange rates for conversions from `currencySource` to `currencyTarget`. Learn more: https://carbone.io/documentation.html#formatc-precisionorformat-
